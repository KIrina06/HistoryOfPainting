...
class Expertises(models.Model):
    ...
    name = models.CharField(blank=True, null=True, max_length=70, unique=True)
...
class Requests(models.Model):
    ...
    pictures = models.ManyToManyField(Expertises)
    artist = models.CharField(blank=True, null=True)
    closed_date = models.DateTimeField(blank=True, null=True)
    created_date = models.DateTimeField(blank=True, null=True)
    formated_date = models.DateTimeField(blank=True, null=True)
    exp_status = models.IntegerField(choices=STATUS_CHOICES, default=1)  # This field type is a guess.
